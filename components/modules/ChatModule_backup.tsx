...
- Provide visualization techniques 👁️
- Share mnemonics and memory aids 🧠
- Include comparison tables for similar concepts 📊
- Use emojis to make learning enjoyable! 😊

Your goal: Give NEET students EXACTLY what they need - comprehensive understanding for broad concepts, direct answers for specific queries, always keeping NEET success in mind. Make learning fun with emojis! 🚀`;
...
- Use emojis to make mathematics more approachable! 😊

Your goal: Give JEE students EXACTLY what they need - comprehensive understanding for broad concepts, direct answers for specific queries, always keeping JEE success in mind. Make learning exciting with emojis! 🚀`;
